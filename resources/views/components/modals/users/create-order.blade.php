                                                ...
                                                <div class="card-body ">
                                                    <div class="row py-3">
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" disabled="" placeholder="Año" id="period">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row py-3">
                                                        <div class="col-md-4 pr-1">
                                                            <div class="form-group">
                                                                <label>Nombres</label>
                                                                <input type="text" class="form-control" placeholder="Nombres" name="firtsname" readonly="" id="firtsname" required="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 pl-1">
                                                            <div class="form-group">
                                                                <label>Apellidos</label>
                                                                <input type="text" class="form-control" placeholder="Apellidos" name="lastname" readonly="" id="lastname" required="">
                                                            </div>
                                                        </div>
                                                         <div class="col-md-4 pr-1">
                                                            <div class="form-group">
                                                                <label>Concepto de Pago</label>
                                                                    <select name="office" id="offices" class="form-control" required=""></select>
                                                            </div>
                                                        </div>
                                                    </div>
