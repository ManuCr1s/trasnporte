<div class="modal fade modal-lg" id="modalDeleteOrder" tabindex="-1" aria-labelledby="modalDeleteOrder" aria-hidden="true">
            ...
            <form id="deleteOrderForm">
                <div class="modal-body px-5">
                        ...
                        <div class="row px-4 py-3">
                            <div class="col-12">
                                <label for="" class="form-label">Motivo de Anulacion</label>
                                <textarea name="motive" id="motive" class="form-control" required></textarea>
                            </div>
                        </div>
                </div>
